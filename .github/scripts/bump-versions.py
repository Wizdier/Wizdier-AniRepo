...
if __name__ == "__main__":
    if len(sys.argv) <= 2:
        print("Usage: bump-versions.py [<message> | --dry-run | --modify-only | --stage-changes] <file>...")
        print("Examples:"
    ...
    libs_to_discover_q = deque()
    all_libs_to_process = set()
    ...
    if not all_libs_to_process:
        ...
        should_bump_theme = sys.argv[1] != "--dry-run"
