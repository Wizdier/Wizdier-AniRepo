...
class AniDB : Source(), ConfigurableAnimeSource {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        screen.addSwitchPreference(
            ...
            summary = "Show episode thumbnails and descriptions in episode list.",
        )
        screen.addSwitchPreference(
            key = PREF_FILLER_KEY,
            title = "Show Filler Info",
            default = PREF_FILLER_DEFAULT,
            summary = "Mark filler episodes in episode list.",
        )
        screen.addListPreference(
            key = PREF_SUB_KEY,
    ...
    companion object {
        ...
        private const val PREF_FILLER_KEY = "pref_mark_fillers"
        private const val PREF_FILLER_DEFAULT = false
